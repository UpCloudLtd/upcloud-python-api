...
from ...models.load_balancer_label_modify import LoadBalancerLabelModify
...
def _get_kwargs(
    ...
    label_key: str,
    *,
    body: LoadBalancerLabelModify | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (LoadBalancerLabelModify | Unset): Load Balancer Label Example: {'key':
