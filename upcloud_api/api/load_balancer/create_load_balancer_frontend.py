...
def _get_kwargs(
    service_uuid: UUID,
    *,
    body: LoadBalancerFrontendCreate | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = LoadBalancerFrontend.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (LoadBalancerFrontendCreate | Unset): Load Balancer Frontend
