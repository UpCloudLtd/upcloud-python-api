...
from ...models.load_balancer_rule_modify import LoadBalancerRuleModify
...
def _get_kwargs(
    ...
    rule_name: str,
    *,
    body: LoadBalancerRuleModify | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/1.3/load-balancer/{service_uuid}/frontends/{frontend_name}/rules/{rule_name}".format(
            service_uuid=quote(str(service_uuid), safe=""),
            frontend_name=quote(str(frontend_name), safe=""),
            rule_name=quote(str(rule_name), safe=""),
        ),
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = LoadBalancerRule.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (LoadBalancerRuleModify | Unset): Load Balancer Forwarding Rule
