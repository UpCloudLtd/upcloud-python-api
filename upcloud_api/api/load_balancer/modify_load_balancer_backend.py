...
from ...models.load_balancer_backend_modify import LoadBalancerBackendModify
...
def _get_kwargs(
    ...
    backend_name: str,
    *,
    body: LoadBalancerBackendModify | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (LoadBalancerBackendModify | Unset): Load Balancer Backend
