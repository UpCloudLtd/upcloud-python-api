...
from ...models.load_balancer_service_replace import LoadBalancerServiceReplace
...
def _get_kwargs(
    service_uuid: UUID,
    *,
    body: LoadBalancerServiceReplace | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (LoadBalancerServiceReplace | Unset): Load Balancer Service.
