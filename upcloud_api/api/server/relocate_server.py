...
from ...models.relocate_server import RelocateServer
...
def _get_kwargs(
    uuid: UUID,
    *,
    body: RelocateServer | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/1.3/server/{uuid}/relocate".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (RelocateServer | Unset): Relocate Cloud Server request Example: {'zone': 'fi-hel2'}.
