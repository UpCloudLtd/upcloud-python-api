...
from ...models.server_gpus import ServerGpus
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/1.3/server/{uuid}/gpus".format(
...
) -> ServerError | ServerError400 | ServerError403 | ServerError404 | ServerGpus:
    if response.status_code == 200:
        response_200 = ServerGpus.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ServerError | ServerError400 | ServerError403 | ServerError404 | ServerGpus]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> ServerError | ServerError400 | ServerError403 | ServerError404 | ServerGpus | None:
    """List Cloud Server GPUs
