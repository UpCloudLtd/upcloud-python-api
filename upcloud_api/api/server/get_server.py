...
) -> Server | ServerError | ServerError400 | ServerError403 | ServerError404:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Server | ServerError | ServerError400 | ServerError403 | ServerError404]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> Server | ServerError | ServerError400 | ServerError403 | ServerError404 | None:
    """Get Cloud Server details
