...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/1.3/server/{uuid}/networking/interface/{index}/ip_address/{ip}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Delete an IP address from a network interface
     ...
     Delete an IP address from a private network interface. At least one IP address must remain attached
    to the interface.

    Args:
        uuid (UUID): Universally unique identifier Example: 0414e0d7-4436-4037-9dd8-6eaf47dce599.
        index (int):
        ip (str): IP address Example: 10.0.0.20.
