...
from ...models.server_networking_response import ServerNetworkingResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/1.3/server/{uuid}/networking".format(
...
) -> ServerError | ServerError400 | ServerError403 | ServerError404 | ServerNetworkingResponse:
    if response.status_code == 200:
        response_200 = ServerNetworkingResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ServerError | ServerError400 | ServerError403 | ServerError404 | ServerNetworkingResponse]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> ServerError | ServerError400 | ServerError403 | ServerError404 | ServerNetworkingResponse | None:
    """Get Cloud Server networking details
