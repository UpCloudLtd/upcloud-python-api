...
from ...models.server_remote_access_details import ServerRemoteAccessDetails
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/1.3/server/{uuid}/remote_access_details".format(
...
) -> ServerError | ServerError400 | ServerError403 | ServerError404 | ServerRemoteAccessDetails:
    if response.status_code == 200:
        response_200 = ServerRemoteAccessDetails.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ServerError | ServerError400 | ServerError403 | ServerError404 | ServerRemoteAccessDetails]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> ServerError | ServerError400 | ServerError403 | ServerError404 | ServerRemoteAccessDetails | None:
    """Get remote access connection details
