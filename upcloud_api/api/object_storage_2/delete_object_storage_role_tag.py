...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/1.3/object-storage-2/{service_uuid}/roles/{role_name}/tags/{role_tag_key}".format(
            service_uuid=quote(str(service_uuid), safe=""),
            role_name=quote(str(role_name), safe=""),
            role_tag_key=quote(str(role_tag_key), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        role_tag_key (str): The key of a tag.
