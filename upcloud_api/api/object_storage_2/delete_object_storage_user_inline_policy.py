...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/1.3/object-storage-2/{service_uuid}/users/{username}/inline-policies/{user_policy_name}".format(
            service_uuid=quote(str(service_uuid), safe=""),
            username=quote(str(username), safe=""),
            user_policy_name=quote(str(user_policy_name), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        user_policy_name (str): A resource name.
