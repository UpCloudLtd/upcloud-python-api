...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/1.3/object-storage-2/{service_uuid}/users/{username}/tags/{user_tag_key}".format(
            service_uuid=quote(str(service_uuid), safe=""),
            username=quote(str(username), safe=""),
            user_tag_key=quote(str(user_tag_key), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        user_tag_key (str): The key of a tag.
