...
def _get_kwargs(
    service_uuid: UUID,
    *,
    body: ObjectStorage2CustomDomainCreate | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ObjectStorage2CustomDomainDetailResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ObjectStorage2CustomDomainCreate | Unset): Schema for creating a custom domain.
