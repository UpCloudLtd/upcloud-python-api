...
from ...models.object_storage_2_policy_create import ObjectStorage2PolicyCreate
...
def _get_kwargs(
    service_uuid: UUID,
    *,
    body: ObjectStorage2PolicyCreate | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ObjectStorage2PolicyDetailResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ObjectStorage2PolicyCreate | Unset): Schema for creating a policy with a name,
