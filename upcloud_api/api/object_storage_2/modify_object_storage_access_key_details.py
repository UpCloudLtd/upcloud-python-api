...
from ...models.object_storage_2_access_key_modify import ObjectStorage2AccessKeyModify
...
def _get_kwargs(
    ...
    access_key_id: str,
    *,
    body: ObjectStorage2AccessKeyModify | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ObjectStorage2AccessKeyModify | Unset): Schema for modifying an access key.
