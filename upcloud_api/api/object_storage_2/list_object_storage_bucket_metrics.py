...
) -> ObjectStorage2ErrorResponse | list[ObjectStorage2BucketDetailResponse]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemasobject_storage_2_bucket_list_response_item_data in _response_200:
            componentsschemasobject_storage_2_bucket_list_response_item = ObjectStorage2BucketDetailResponse.from_dict(
                componentsschemasobject_storage_2_bucket_list_response_item_data
            )

            response_200.append(componentsschemasobject_storage_2_bucket_list_response_item)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ObjectStorage2ErrorResponse | list[ObjectStorage2BucketDetailResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    limit: int | Unset = UNSET,
    offset: int | Unset = UNSET,
) -> ObjectStorage2ErrorResponse | list[ObjectStorage2BucketDetailResponse] | None:
    """List bucket metrics
