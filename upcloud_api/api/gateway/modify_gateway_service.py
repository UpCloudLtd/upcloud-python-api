...
from ...models.gateway_service_modify_request import GatewayServiceModifyRequest
...
def _get_kwargs(
    service_uuid: UUID,
    *,
    body: GatewayServiceModifyRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (GatewayServiceModifyRequest | Unset): Request to modify a gateway service
