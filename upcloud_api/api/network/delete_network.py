...
def sync_detailed(
    ...
    *,
    ...
    """Delete network
     ...
     Deletes an SDN private network. All attached cloud servers must first be detached before SDN private
    networks can be deleted. Utility and public networks can only be detached from servers by [Releasing
    the corresponding IP addresses](https://upcloudltd.github.io/upcloud-openapi-spec/api/ip-
    address#delete-ip-address).
