...
def _get_kwargs(
    ruleset_uuid: UUID,
    *,
    body: FirewallRulesetFirewallRuleCreate | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = FirewallRulesetRuleDetailResponse.from_dict(response.json())
