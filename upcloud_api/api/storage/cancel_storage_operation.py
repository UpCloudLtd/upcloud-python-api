...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/1.3/storage/{uuid}/cancel".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Cancel Block Storage operation
     ...
     Requests cancellation of an interruptible operation on block storage in the `maintenance` state. For
    a running clone, cancellation removes the incomplete copy and returns the source block storage to
    the `online` state.
