...
from ...models.storage_access_filter import StorageAccessFilter
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/1.3/storage/{type_}/{access}".format(
            type_=quote(str(type_), safe=""),
            access=quote(str(access), safe=""),
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        access (StorageAccessFilter): Storage resource access type to return.
