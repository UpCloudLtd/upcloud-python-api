...
T = TypeVar("T", bound="DatabaseServiceTaskBaseResponse")


@_attrs_define
class DatabaseServiceTaskBaseResponse:
    """Schema for representing a service task response
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        database_service_task_base_response = cls(
        ...
        return database_service_task_base_response
