...
T = TypeVar("T", bound="DatabasePropertySchemaResponseDependencies")


@_attrs_define
class DatabasePropertySchemaResponseDependencies:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        database_property_schema_response_dependencies = cls()
        ...
        database_property_schema_response_dependencies.additional_properties = additional_properties
        return database_property_schema_response_dependencies
