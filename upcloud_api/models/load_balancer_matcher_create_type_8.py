...
T = TypeVar("T", bound="LoadBalancerMatcherCreateType8")


@_attrs_define
class LoadBalancerMatcherCreateType8:
    """
    Attributes:
        type_ (Literal['url']):
        match_url (LoadBalancerMatcherStringCreateType0 | LoadBalancerMatcherStringCreateType1): Forwarding rule string
            matcher
        inverse (bool | Unset): Inverse rule
    """

    type_: Literal["url"]
    match_url: LoadBalancerMatcherStringCreateType0 | LoadBalancerMatcherStringCreateType1
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        match_url: dict[str, Any]
        if isinstance(self.match_url, LoadBalancerMatcherStringCreateType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        match_url = _parse_match_url(d.pop("match_url"))

        inverse = d.pop("inverse", UNSET)

        load_balancer_matcher_create_type_8 = cls(
            type_=type_,
            match_url=match_url,
            inverse=inverse,
        )

        return load_balancer_matcher_create_type_8
