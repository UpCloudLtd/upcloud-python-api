...
T = TypeVar("T", bound="LoadBalancerActionHttpRewritePathResponse")


@_attrs_define
class LoadBalancerActionHttpRewritePathResponse:
    ...
    Attributes:
        match_pattern (str): Regex pattern to match against the path.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        load_balancer_action_http_rewrite_path_response = cls(
            match_pattern=match_pattern,
            rewrite_to=rewrite_to,
        )

        return load_balancer_action_http_rewrite_path_response
