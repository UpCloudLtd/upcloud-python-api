...
T = TypeVar("T", bound="LoadBalancerMatcherCreateType13")


@_attrs_define
class LoadBalancerMatcherCreateType13:
    """
    Attributes:
        type_ (Literal['response_header']):
        match_response_header (LoadBalancerMatcherStringArgCreateType0 | LoadBalancerMatcherStringArgCreateType1):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        match_response_header: dict[str, Any]
        if isinstance(self.match_response_header, LoadBalancerMatcherStringArgCreateType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = cast(Literal["response_header"], d.pop("type"))
        if type_ != "response_header":
            raise ValueError(f"type must match const 'response_header', got '{type_}'")

        def _parse_match_response_header(
            data: object,
        ...
        match_response_header = _parse_match_response_header(d.pop("match_response_header"))

        inverse = d.pop("inverse", UNSET)

        load_balancer_matcher_create_type_13 = cls(
            type_=type_,
            match_response_header=match_response_header,
            inverse=inverse,
        )

        return load_balancer_matcher_create_type_13
