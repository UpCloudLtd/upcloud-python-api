...
T = TypeVar("T", bound="ServerAttachPrivateFirewallRulesetFirewallRuleset")


@_attrs_define
class ServerAttachPrivateFirewallRulesetFirewallRuleset:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        server_attach_private_firewall_ruleset_firewall_ruleset = cls(
            firewall_ruleset_uuid=firewall_ruleset_uuid,
        )

        return server_attach_private_firewall_ruleset_firewall_ruleset
