...
T = TypeVar("T", bound="AttachStorageResponse")


@_attrs_define
class AttachStorageResponse:
    """Response containing the attached storage resource and its Cloud Server attachment.
    ...
    Example:
        {'storage': {'access': 'private', 'backup_rule': {}, 'backups': {'backup': []}, 'created':
            ...
            'license': 0, 'servers': {'server': ['009d64ef-31d1-4684-a26b-c86c955cbf46']}, 'size': 50, 'state': 'online',
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attach_storage_response = cls(
            storage=storage,
        )

        return attach_storage_response
