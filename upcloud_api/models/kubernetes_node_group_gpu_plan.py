...
T = TypeVar("T", bound="KubernetesNodeGroupGPUPlan")
...
class KubernetesNodeGroupGPUPlan:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kubernetes_node_group_gpu_plan = cls(
            storage_size=storage_size,
            storage_tier=storage_tier,
        )

        kubernetes_node_group_gpu_plan.additional_properties = d
        return kubernetes_node_group_gpu_plan
