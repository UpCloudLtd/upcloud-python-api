...
T = TypeVar("T", bound="ServerCpuStatsStatsMonthly")


@_attrs_define
class ServerCpuStatsStatsMonthly:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        server_cpu_stats_stats_monthly = cls(
            summary=summary,
        )

        server_cpu_stats_stats_monthly.additional_properties = d
        return server_cpu_stats_stats_monthly
