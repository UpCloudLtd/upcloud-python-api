...
T = TypeVar("T", bound="DatabaseServiceCloneRedisMaintenance")


@_attrs_define
class DatabaseServiceCloneRedisMaintenance:
    """Maintenance
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        database_service_clone_redis_maintenance = cls(
            dow=dow,
            time=time,
        )

        database_service_clone_redis_maintenance.additional_properties = d
        return database_service_clone_redis_maintenance
