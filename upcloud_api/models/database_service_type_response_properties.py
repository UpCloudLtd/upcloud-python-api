...
T = TypeVar("T", bound="DatabaseServiceTypeResponseProperties")


@_attrs_define
class DatabaseServiceTypeResponseProperties:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        database_service_type_response_properties = cls()
        ...
        database_service_type_response_properties.additional_properties = additional_properties
        return database_service_type_response_properties
