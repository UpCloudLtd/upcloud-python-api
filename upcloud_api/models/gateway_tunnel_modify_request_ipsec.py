...
if TYPE_CHECKING:
    from ..models.gateway_tunnel_modify_request_ipsec_authentication import (
        GatewayTunnelModifyRequestIpsecAuthentication,
    )


T = TypeVar("T", bound="GatewayTunnelModifyRequestIpsec")


@_attrs_define
class GatewayTunnelModifyRequestIpsec:
    """IPsec configuration

    Attributes:
        authentication (GatewayTunnelModifyRequestIpsecAuthentication): IPsec authentication configuration
        phase1_algorithms (list[GatewaySupportedProposalAlgorithms] | Unset): Phase 1 algorithms
        phase2_algorithms (list[GatewaySupportedProposalAlgorithms] | Unset): Phase 2 algorithms
    ...
    authentication: GatewayTunnelModifyRequestIpsecAuthentication
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.gateway_tunnel_modify_request_ipsec_authentication import (
            GatewayTunnelModifyRequestIpsecAuthentication,  # noqa: PLC0415
        )

        d = dict(src_dict)
        authentication = GatewayTunnelModifyRequestIpsecAuthentication.from_dict(d.pop("authentication"))
        ...
        gateway_tunnel_modify_request_ipsec = cls(
            authentication=authentication,
        ...
        return gateway_tunnel_modify_request_ipsec
