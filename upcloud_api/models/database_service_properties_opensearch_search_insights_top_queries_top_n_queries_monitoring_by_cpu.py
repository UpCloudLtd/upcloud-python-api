...
T = TypeVar("T", bound="DatabaseServicePropertiesOpensearchSearchInsightsTopQueriesTopNQueriesMonitoringByCPU")


@_attrs_define
class DatabaseServicePropertiesOpensearchSearchInsightsTopQueriesTopNQueriesMonitoringByCPU:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        database_service_properties_opensearch_search_insights_top_queries_top_n_queries_monitoring_by_cpu = cls(
            enabled=enabled,
            top_n_size=top_n_size,
            window_size=window_size,
        )

        return database_service_properties_opensearch_search_insights_top_queries_top_n_queries_monitoring_by_cpu
