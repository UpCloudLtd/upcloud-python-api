...
T = TypeVar("T", bound="DatabaseServiceUserAclModifyPgAccessControl")


@_attrs_define
class DatabaseServiceUserAclModifyPgAccessControl:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        database_service_user_acl_modify_pg_access_control = cls(
            allow_replication=allow_replication,
        )

        return database_service_user_acl_modify_pg_access_control
