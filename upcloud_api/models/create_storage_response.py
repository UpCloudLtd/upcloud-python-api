...
T = TypeVar("T", bound="CreateStorageResponse")


@_attrs_define
class CreateStorageResponse:
    """Response containing the created block storage resource.

    Example:
        {'storage': {'access': 'private', 'backup_rule': {'interval': 'daily', 'retention': '7', 'time': '0400'},
            'backups': {'backup': []}, 'created': '2026-08-26T09:15:00Z', 'encrypted': 'yes', 'labels': [{'key':
            'environment', 'value': 'production'}], 'license': 0, 'servers': {'server': []}, 'size': 50, 'state': 'online',
            'tier': 'maxiops', 'title': 'Production data', 'type': 'normal', 'uuid': '01d4fcd4-e446-433b-8a9c-551a1284952e',
            'zone': 'fi-hel1'}}
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_storage_response = cls(
            storage=storage,
        )

        return create_storage_response
