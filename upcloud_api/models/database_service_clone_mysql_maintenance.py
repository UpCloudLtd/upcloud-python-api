...
T = TypeVar("T", bound="DatabaseServiceCloneMysqlMaintenance")


@_attrs_define
class DatabaseServiceCloneMysqlMaintenance:
    """Maintenance
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        database_service_clone_mysql_maintenance = cls(
            dow=dow,
            time=time,
        )

        database_service_clone_mysql_maintenance.additional_properties = d
        return database_service_clone_mysql_maintenance
