...
from ..models.database_service_clone_valkey_plan_backups import DatabaseServiceCloneValkeyPlanBackups
...
if TYPE_CHECKING:
    ...
    from ..models.database_service_clone_valkey_maintenance import DatabaseServiceCloneValkeyMaintenance
    from ..models.database_service_properties_valkey import DatabaseServicePropertiesValkey


T = TypeVar("T", bound="DatabaseServiceCloneValkey")


@_attrs_define
class DatabaseServiceCloneValkey:
    """Schema for cloning a service with valkey.
    ...
    Attributes:
        ...
        plan_backups (DatabaseServiceCloneValkeyPlanBackups | Unset): Plan selection: backup tier. PostgreSQL and MySQL
            tiered plans only.
        ...
        maintenance (DatabaseServiceCloneValkeyMaintenance | Unset): Maintenance
        networks (list[DatabaseNetworkCreate] | Unset):
        labels (list[DatabaseLabelCreate] | Unset): Labels
        properties (DatabaseServicePropertiesValkey | Unset): valkey properties
    """
    ...
    plan_backups: DatabaseServiceCloneValkeyPlanBackups | Unset = UNSET
    ...
    maintenance: DatabaseServiceCloneValkeyMaintenance | Unset = UNSET
    networks: list[DatabaseNetworkCreate] | Unset = UNSET
    labels: list[DatabaseLabelCreate] | Unset = UNSET
    properties: DatabaseServicePropertiesValkey | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.database_service_clone_valkey_maintenance import (
            DatabaseServiceCloneValkeyMaintenance,  # noqa: PLC0415
        )
        ...
        plan_backups: DatabaseServiceCloneValkeyPlanBackups | Unset
        if isinstance(_plan_backups, Unset):
            plan_backups = UNSET
        else:
            plan_backups = DatabaseServiceCloneValkeyPlanBackups(_plan_backups)
        ...
        maintenance: DatabaseServiceCloneValkeyMaintenance | Unset
        if isinstance(_maintenance, Unset):
            maintenance = UNSET
        else:
            maintenance = DatabaseServiceCloneValkeyMaintenance.from_dict(_maintenance)
        ...
        properties: DatabaseServicePropertiesValkey | Unset
        if isinstance(_properties, Unset):
            properties = UNSET
        else:
            properties = DatabaseServicePropertiesValkey.from_dict(_properties)

        database_service_clone_valkey = cls(
            hostname_prefix=hostname_prefix,
            plan=plan,
        ...
        return database_service_clone_valkey
