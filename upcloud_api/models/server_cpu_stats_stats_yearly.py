...
T = TypeVar("T", bound="ServerCpuStatsStatsYearly")


@_attrs_define
class ServerCpuStatsStatsYearly:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        server_cpu_stats_stats_yearly = cls(
            summary=summary,
        )

        server_cpu_stats_stats_yearly.additional_properties = d
        return server_cpu_stats_stats_yearly
