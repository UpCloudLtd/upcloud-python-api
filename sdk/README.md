...
```python
from upcloud_api import Client
...
```python
from upcloud_api.models import MyDataModel
from upcloud_api.api.my_tag import get_my_data_model
from upcloud_api.types import Response
...
1. Any endpoint which did not have a tag will be in `upcloud_api.api.default`
