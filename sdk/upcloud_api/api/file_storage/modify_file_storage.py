...
from ...models.file_storage_service_modify import FileStorageServiceModify
...
def _get_kwargs(
    service_uuid: UUID,
    *,
    body: FileStorageServiceModify | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (FileStorageServiceModify | Unset): Schema for modifying an existing service.
