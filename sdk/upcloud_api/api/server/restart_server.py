...
from ...models.restart_server import RestartServer
...
def _get_kwargs(
    uuid: UUID,
    *,
    body: RestartServer | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/1.3/server/{uuid}/restart".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (RestartServer | Unset): Restart Cloud Server request Example: {'restart_server':
            {'stop_type': 'soft', 'timeout': '60', 'timeout_action': 'destroy'}}.
