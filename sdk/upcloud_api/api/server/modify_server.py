...
from ...models.modify_server import ModifyServer
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ModifyServer | Unset): Fields that can be changed on an existing Cloud Server
            Example: {'server': {'core_number': 8, 'memory_amount': 16384, 'plan': 'custom'}}.
