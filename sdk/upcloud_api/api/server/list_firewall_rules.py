...
from ...models.server_firewall_rules import ServerFirewallRules
...
) -> ServerError | ServerError400 | ServerError403 | ServerError404 | ServerFirewallRules:
    if response.status_code == 200:
        response_200 = ServerFirewallRules.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ServerError | ServerError400 | ServerError403 | ServerError404 | ServerFirewallRules]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """List firewall rules
     ...
     Return the Cloud Server firewall rules in evaluation order. Changes to firewall rules can take 1-2
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> ServerError | ServerError400 | ServerError403 | ServerError404 | ServerFirewallRules | None:
    """List firewall rules
