...
from ...models.database_service_user_acl_modify import DatabaseServiceUserAclModify
...
def _get_kwargs(
    ...
    username: str,
    *,
    body: DatabaseServiceUserAclModify | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/1.3/database/{uuid}/users/{username}/access-control".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (DatabaseServiceUserAclModify | Unset): Schema for modifying user access control
            lists (ACL) for various services
