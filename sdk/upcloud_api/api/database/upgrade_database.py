...
from ...models.database_service_upgrade import DatabaseServiceUpgrade
...
def _get_kwargs(
    uuid: UUID,
    *,
    body: DatabaseServiceUpgrade | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/1.3/database/{uuid}/upgrade".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Upgrade database
     ...
     Upgrades your PostgreSQL Managed Database service database to a newer major version. Downgrades are
    not permitted.

    Args:
        uuid (UUID): The unique identifier for the integration.
        body (DatabaseServiceUpgrade | Unset): Schema for upgrading the service version
