...
from ...models.database_service_type_modify import DatabaseServiceTypeModify
...
def _get_kwargs(
    uuid: UUID,
    *,
    body: DatabaseServiceTypeModify | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/1.3/database/{uuid}/service-type".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (DatabaseServiceTypeModify | Unset): Schema for modifying the service type
