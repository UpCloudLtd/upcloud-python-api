...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/1.3/storage/{uuid}/restore".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Restore Block Storage from backup
     ...
     Starts restoring the backup identified by `uuid` to its origin block storage. If the origin block
    storage is attached to a Cloud Server, the Cloud Server must be stopped.
