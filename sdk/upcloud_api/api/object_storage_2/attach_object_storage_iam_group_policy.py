...
from ...models.object_storage_2_policy_attachment_create import ObjectStorage2PolicyAttachmentCreate
...
def _get_kwargs(
    ...
    group_name: str,
    *,
    body: ObjectStorage2PolicyAttachmentCreate | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/1.3/object-storage-2/{service_uuid}/groups/{group_name}/policies".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ObjectStorage2PolicyAttachmentCreate | Unset): Schema for creating a policy
            attachment.
