...
from ...models.object_storage_2_service_modify import ObjectStorage2ServiceModify
...
def _get_kwargs(
    service_uuid: UUID,
    *,
    body: ObjectStorage2ServiceModify | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ObjectStorage2ServiceModify | Unset): Schema for modifying a service, including
