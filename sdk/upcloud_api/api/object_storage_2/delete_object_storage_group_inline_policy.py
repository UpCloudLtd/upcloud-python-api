...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/1.3/object-storage-2/{service_uuid}/groups/{group_name}/inline-policies/{group_policy_name}".format(
            service_uuid=quote(str(service_uuid), safe=""),
            group_name=quote(str(group_name), safe=""),
            group_policy_name=quote(str(group_policy_name), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        group_policy_name (str): A resource name.
