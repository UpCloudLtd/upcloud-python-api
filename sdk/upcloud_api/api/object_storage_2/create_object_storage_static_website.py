...
def _get_kwargs(
    service_uuid: UUID,
    *,
    body: ObjectStorage2StaticWebsiteConfigCreate | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ObjectStorage2StaticWebsiteConfig.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ObjectStorage2StaticWebsiteConfigCreate | Unset): Request body for creating a static
            website configuration. If domain is omitted, the primary static website domain is used.
