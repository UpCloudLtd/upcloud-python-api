...
from ...models.object_storage_2_user_create import ObjectStorage2UserCreate
...
def _get_kwargs(
    service_uuid: UUID,
    *,
    body: ObjectStorage2UserCreate | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ObjectStorage2UserDetailResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ObjectStorage2UserCreate | Unset): Schema for creating a new user.
