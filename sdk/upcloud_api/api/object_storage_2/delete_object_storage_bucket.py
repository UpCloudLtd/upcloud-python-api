...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/1.3/object-storage-2/{service_uuid}/buckets/{bucket_name}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Delete bucket
     ...
     Deletes an existing bucket by given {service_uuid} and {bucket_name}. This API call will remove all
    objects from the bucket permanently and cannot be reversed.

    Args:
        service_uuid (UUID): The unique identifier for the service.
        bucket_name (str): A resource name.
