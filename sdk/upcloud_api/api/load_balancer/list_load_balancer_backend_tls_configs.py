...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/1.3/load-balancer/{service_uuid}/backends/{backend_name}/tls-configs".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for componentsschemasload_balancer_tls_configs_response_item_data in _response_200:
            ...
            response_200.append(componentsschemasload_balancer_tls_configs_response_item)
