...
def _get_kwargs(
    service_uuid: UUID,
    *,
    body: LoadBalancerResolverCreate | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = LoadBalancerResolver.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Resolver is a DNS server usually residing in a user's private network. It's used to resolve IPs for
    backend members of type dynamic.

    Args:
        service_uuid (UUID): The UUID of the service.
        body (LoadBalancerResolverCreate | Unset): Load Balancer Resolver Example: {'name':
