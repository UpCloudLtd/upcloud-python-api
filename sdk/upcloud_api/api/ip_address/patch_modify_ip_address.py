...
from ...models.patch_ip_address_request_v13 import PatchIpAddressRequestV13
...
def _get_kwargs(
    address: str,
    *,
    body: PatchIpAddressRequestV13 | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        address (str):
        body (PatchIpAddressRequestV13 | Unset): Request schema for modifying an IP address
