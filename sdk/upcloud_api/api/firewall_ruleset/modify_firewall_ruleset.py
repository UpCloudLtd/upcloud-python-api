...
from ...models.firewall_ruleset_modify import FirewallRulesetModify
...
def _get_kwargs(
    ruleset_uuid: UUID,
    *,
    body: FirewallRulesetModify | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (FirewallRulesetModify | Unset): Modify firewall ruleset
