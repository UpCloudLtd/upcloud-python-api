...
T = TypeVar("T", bound="LoadBalancerMatchStringResponse")


@_attrs_define
class LoadBalancerMatchStringResponse:
    """Defines a string-based match condition, used for matching values such as paths, headers, URLs, or hostnames.

    Example:
        {'method': 'contains', 'value': '/api', 'ignore_case': True}
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        load_balancer_match_string_response = cls(
            method=method,
            value=value,
            ignore_case=ignore_case,
        )

        load_balancer_match_string_response.additional_properties = d
        return load_balancer_match_string_response
