...
T = TypeVar("T", bound="ServerDiskStatsStatsMonthly")


@_attrs_define
class ServerDiskStatsStatsMonthly:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        server_disk_stats_stats_monthly = cls(
            summary=summary,
        )

        server_disk_stats_stats_monthly.additional_properties = d
        return server_disk_stats_stats_monthly
