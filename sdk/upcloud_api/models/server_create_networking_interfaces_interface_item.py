...
if TYPE_CHECKING:
    from ..models.server_create_networking_interfaces_interface_item_ip_addresses import (
        ServerCreateNetworkingInterfacesInterfaceItemIpAddresses,
    )


T = TypeVar("T", bound="ServerCreateNetworkingInterfacesInterfaceItem")


@_attrs_define
class ServerCreateNetworkingInterfacesInterfaceItem:
    """
    Attributes:
        ip_addresses (ServerCreateNetworkingInterfacesInterfaceItemIpAddresses):
        ...
        index (int | Unset): Index used to identify and order the network interface
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.server_create_networking_interfaces_interface_item_ip_addresses import (
            ServerCreateNetworkingInterfacesInterfaceItemIpAddresses,  # noqa: PLC0415
        )

        d = dict(src_dict)
        ip_addresses = ServerCreateNetworkingInterfacesInterfaceItemIpAddresses.from_dict(d.pop("ip_addresses"))
        ...
        server_create_networking_interfaces_interface_item = cls(
            ip_addresses=ip_addresses,
            type_=type_,
            bootable=bootable,
            index=index,
        ...
        return server_create_networking_interfaces_interface_item
