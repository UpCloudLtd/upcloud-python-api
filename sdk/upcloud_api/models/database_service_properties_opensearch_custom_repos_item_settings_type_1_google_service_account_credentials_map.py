...
T = TypeVar(
    "T", bound="DatabaseServicePropertiesOpensearchCustomReposItemSettingsType1GoogleServiceAccountCredentialsMap"
)


@_attrs_define
class DatabaseServicePropertiesOpensearchCustomReposItemSettingsType1GoogleServiceAccountCredentialsMap:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        database_service_properties_opensearch_custom_repos_item_settings_type_1_google_service_account_credentials_map = cls(
            client_email=client_email,
            client_id=client_id,
            private_key=private_key,
            private_key_id=private_key_id,
        ...
        return database_service_properties_opensearch_custom_repos_item_settings_type_1_google_service_account_credentials_map
