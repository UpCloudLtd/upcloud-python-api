...
T = TypeVar("T", bound="NetworkPeeringNetworkIpNetworksIpNetworkItem")


@_attrs_define
class NetworkPeeringNetworkIpNetworksIpNetworkItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        network_peering_network_ip_networks_ip_network_item = cls(
            address=address,
            family=family,
        )

        network_peering_network_ip_networks_ip_network_item.additional_properties = d
        return network_peering_network_ip_networks_ip_network_item
