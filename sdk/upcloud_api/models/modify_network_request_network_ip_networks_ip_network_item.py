...
T = TypeVar("T", bound="ModifyNetworkRequestNetworkIpNetworksIpNetworkItem")


@_attrs_define
class ModifyNetworkRequestNetworkIpNetworksIpNetworkItem:
    """
    Attributes:
        ...
        dhcp (str | Unset):
        dhcp_default_route (str | Unset):
        dhcp_dns (list[str] | Unset):
        dhcp_routes (list[str] | Unset):
        dhcp_bootfile_url (str | Unset):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        dhcp_default_route = self.dhcp_default_route
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dhcp_default_route = d.pop("dhcp_default_route", UNSET)
        ...
        modify_network_request_network_ip_networks_ip_network_item = cls(
            family=family,
            address=address,
            gateway=gateway,
            dhcp=dhcp,
        ...
        modify_network_request_network_ip_networks_ip_network_item.additional_properties = d
        return modify_network_request_network_ip_networks_ip_network_item
