...
T = TypeVar("T", bound="FirewallRulesetServerMultipleFirewallRulesCreateFirewallRulesType1")


@_attrs_define
class FirewallRulesetServerMultipleFirewallRulesCreateFirewallRulesType1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        firewall_ruleset_server_multiple_firewall_rules_create_firewall_rules_type_1 = cls(
            firewall_rule=firewall_rule,
        )

        return firewall_ruleset_server_multiple_firewall_rules_create_firewall_rules_type_1
