...
from ..models.database_service_clone_opensearch_plan_backups import DatabaseServiceCloneOpensearchPlanBackups
...
if TYPE_CHECKING:
    ...
    from ..models.database_service_clone_opensearch_maintenance import DatabaseServiceCloneOpensearchMaintenance
    from ..models.database_service_properties_opensearch import DatabaseServicePropertiesOpensearch


T = TypeVar("T", bound="DatabaseServiceCloneOpensearch")


@_attrs_define
class DatabaseServiceCloneOpensearch:
    """Schema for cloning an OpenSearch service
    ...
    Attributes:
        ...
        plan_backups (DatabaseServiceCloneOpensearchPlanBackups | Unset): Plan selection: backup tier. PostgreSQL and
        ...
        maintenance (DatabaseServiceCloneOpensearchMaintenance | Unset): Maintenance
        networks (list[DatabaseNetworkCreate] | Unset): Networks
        labels (list[DatabaseLabelCreate] | Unset): Labels
        additional_disk_space_gib (int | Unset): Additional disk space in GiB
        properties (DatabaseServicePropertiesOpensearch | Unset): opensearch properties
    """
    ...
    plan_backups: DatabaseServiceCloneOpensearchPlanBackups | Unset = UNSET
    ...
    maintenance: DatabaseServiceCloneOpensearchMaintenance | Unset = UNSET
    ...
    properties: DatabaseServicePropertiesOpensearch | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.database_service_clone_opensearch_maintenance import (
            DatabaseServiceCloneOpensearchMaintenance,  # noqa: PLC0415
        )
        ...
        plan_backups: DatabaseServiceCloneOpensearchPlanBackups | Unset
        if isinstance(_plan_backups, Unset):
            plan_backups = UNSET
        else:
            plan_backups = DatabaseServiceCloneOpensearchPlanBackups(_plan_backups)
        ...
        maintenance: DatabaseServiceCloneOpensearchMaintenance | Unset
        if isinstance(_maintenance, Unset):
            maintenance = UNSET
        else:
            maintenance = DatabaseServiceCloneOpensearchMaintenance.from_dict(_maintenance)
        ...
        properties: DatabaseServicePropertiesOpensearch | Unset
        if isinstance(_properties, Unset):
            properties = UNSET
        else:
            properties = DatabaseServicePropertiesOpensearch.from_dict(_properties)

        database_service_clone_opensearch = cls(
            hostname_prefix=hostname_prefix,
            plan=plan,
        ...
        return database_service_clone_opensearch
