...
T = TypeVar("T", bound="FirewallRulesetServerFirewallRuleDetail")


@_attrs_define
class FirewallRulesetServerFirewallRuleDetail:
    """Server firewall rule detail
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        firewall_ruleset_server_firewall_rule_detail = cls(
            firewall_rule=firewall_rule,
        )

        return firewall_ruleset_server_firewall_rule_detail
