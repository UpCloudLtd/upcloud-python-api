...
T = TypeVar("T", bound="KubernetesNodeGroupDetails")


@_attrs_define
class KubernetesNodeGroupDetails:
    ...
    Attributes:
        ...
        nodes (list[KubernetesNode]): List of node group nodes (experimental)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.kubernetes_node import KubernetesNode  # noqa: PLC0415
        ...
        for nodes_item_data in _nodes:
            nodes_item = KubernetesNode.from_dict(nodes_item_data)
        ...
        kubernetes_node_group_details = cls(
            count=count,
            name=name,
            plan=plan,
            nodes=nodes,
        ...
        kubernetes_node_group_details.additional_properties = d
        return kubernetes_node_group_details
