...
class CreateServerResponse:
    """Newly created Cloud Server and optional one-time login credentials

    Example:
        {'server': {'core_number': '2', 'created': 1705320000, 'hostname': 'my-server.example.com', 'license': '0',
            'memory_amount': '2048', 'state': 'maintenance', 'title': 'My Server', 'uuid':
