...
T = TypeVar("T", bound="DatabaseValkeyAccessControlResponse")


@_attrs_define
class DatabaseValkeyAccessControlResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        database_valkey_access_control_response = cls(
        ...
        database_valkey_access_control_response.additional_properties = d
        return database_valkey_access_control_response
