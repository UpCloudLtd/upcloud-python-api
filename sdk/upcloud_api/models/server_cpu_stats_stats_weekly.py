...
T = TypeVar("T", bound="ServerCpuStatsStatsWeekly")


@_attrs_define
class ServerCpuStatsStatsWeekly:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        server_cpu_stats_stats_weekly = cls(
            summary=summary,
        )

        server_cpu_stats_stats_weekly.additional_properties = d
        return server_cpu_stats_stats_weekly
