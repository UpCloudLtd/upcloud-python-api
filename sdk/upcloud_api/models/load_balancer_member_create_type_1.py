...
T = TypeVar("T", bound="LoadBalancerMemberCreateType1")


@_attrs_define
class LoadBalancerMemberCreateType1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        load_balancer_member_create_type_1 = cls(
            type_=type_,
            ip=ip,
            port=port,
        )

        load_balancer_member_create_type_1.additional_properties = d
        return load_balancer_member_create_type_1
