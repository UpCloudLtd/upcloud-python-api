...
from ..models.database_service_clone_pg_plan_backups import DatabaseServiceClonePgPlanBackups
...
if TYPE_CHECKING:
    ...
    from ..models.database_service_clone_pg_maintenance import DatabaseServiceClonePgMaintenance
    from ..models.database_service_properties_pg import DatabaseServicePropertiesPg


T = TypeVar("T", bound="DatabaseServiceClonePg")


@_attrs_define
class DatabaseServiceClonePg:
    """Schema for cloning a PostgreSQL service.
    ...
    Attributes:
        ...
        plan_backups (DatabaseServiceClonePgPlanBackups | Unset): Plan selection: backup tier. PostgreSQL and MySQL
            tiered plans only.
        ...
        maintenance (DatabaseServiceClonePgMaintenance | Unset): Maintenance
        ...
        properties (DatabaseServicePropertiesPg | Unset): pg properties
    """
    ...
    plan_backups: DatabaseServiceClonePgPlanBackups | Unset = UNSET
    ...
    maintenance: DatabaseServiceClonePgMaintenance | Unset = UNSET
    ...
    properties: DatabaseServicePropertiesPg | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.database_service_clone_pg_maintenance import DatabaseServiceClonePgMaintenance  # noqa: PLC0415
        ...
        plan_backups: DatabaseServiceClonePgPlanBackups | Unset
        if isinstance(_plan_backups, Unset):
            plan_backups = UNSET
        else:
            plan_backups = DatabaseServiceClonePgPlanBackups(_plan_backups)
        ...
        maintenance: DatabaseServiceClonePgMaintenance | Unset
        if isinstance(_maintenance, Unset):
            maintenance = UNSET
        else:
            maintenance = DatabaseServiceClonePgMaintenance.from_dict(_maintenance)
        ...
        properties: DatabaseServicePropertiesPg | Unset
        if isinstance(_properties, Unset):
            properties = UNSET
        else:
            properties = DatabaseServicePropertiesPg.from_dict(_properties)

        database_service_clone_pg = cls(
            hostname_prefix=hostname_prefix,
            plan=plan,
        ...
        return database_service_clone_pg
