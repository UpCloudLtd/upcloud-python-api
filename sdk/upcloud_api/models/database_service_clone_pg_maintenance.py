...
T = TypeVar("T", bound="DatabaseServiceClonePgMaintenance")


@_attrs_define
class DatabaseServiceClonePgMaintenance:
    """Maintenance
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        database_service_clone_pg_maintenance = cls(
            dow=dow,
            time=time,
        )

        database_service_clone_pg_maintenance.additional_properties = d
        return database_service_clone_pg_maintenance
