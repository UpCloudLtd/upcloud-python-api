...
if TYPE_CHECKING:
    ...
    from ..models.router_modify_router_static_routes_item import RouterModifyRouterStaticRoutesItem


T = TypeVar("T", bound="RouterModifyRouter")


@_attrs_define
class RouterModifyRouter:
    """
    Example:
    ...
    Attributes:
        name (str | Unset):  Example: Example router.
        static_routes (list[RouterModifyRouterStaticRoutesItem] | Unset): Static routes that will be added to the
    ...
    static_routes: list[RouterModifyRouterStaticRoutesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.router_modify_router_static_routes_item import RouterModifyRouterStaticRoutesItem  # noqa: PLC0415
        ...
        if _static_routes is not UNSET:
            ...
            for static_routes_item_data in _static_routes:
                static_routes_item = RouterModifyRouterStaticRoutesItem.from_dict(static_routes_item_data)
        ...
        router_modify_router = cls(
            name=name,
            static_routes=static_routes,
            labels=labels,
        )

        return router_modify_router
