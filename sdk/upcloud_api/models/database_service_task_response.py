...
T = TypeVar("T", bound="DatabaseServiceTaskResponse")


@_attrs_define
class DatabaseServiceTaskResponse:
    """Response schema for retrieving information about a service task, including the operation type.

    Attributes:
        create_time (datetime.datetime | Unset): The time when the service task was created Example:
            2022-10-04T12:21:42Z.
        result (str | Unset): Optional result message Example: All pre-checks passed successfully, preferred migration
            method will be [Replication].
        ...
        success (bool | Unset): Indicates if the operation was successful Example: True.
        ...
        operation_type (str | Unset): The type of operation being performed. Example: async.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        database_service_task_response = cls(
        ...
        database_service_task_response.additional_properties = d
        return database_service_task_response
