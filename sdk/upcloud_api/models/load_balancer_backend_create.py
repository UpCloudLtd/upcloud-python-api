...
T = TypeVar("T", bound="LoadBalancerBackendCreate")


@_attrs_define
class LoadBalancerBackendCreate:
    """Load Balancer Backend

    Attributes:
        name (str): Name of the backend Example: my-backend.
        members (list[LoadBalancerMemberCreateType0 | LoadBalancerMemberCreateType1] | None): Backend members
    ...
    name: str
    members: list[LoadBalancerMemberCreateType0 | LoadBalancerMemberCreateType1] | None
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.load_balancer_member_create_type_0 import LoadBalancerMemberCreateType0  # noqa: PLC0415
        ...
        if isinstance(self.members, list):
            ...
            for members_type_0_item_data in self.members:
                ...
                if isinstance(members_type_0_item_data, LoadBalancerMemberCreateType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.load_balancer_member_create_type_0 import LoadBalancerMemberCreateType0  # noqa: PLC0415
        from ..models.load_balancer_member_create_type_1 import LoadBalancerMemberCreateType1  # noqa: PLC0415
        from ..models.load_balancer_tls_config_create import LoadBalancerTlsConfigCreate  # noqa: PLC0415

        d = dict(src_dict)
        name = d.pop("name")

        def _parse_members(data: object) -> list[LoadBalancerMemberCreateType0 | LoadBalancerMemberCreateType1] | None:
            if data is None:
                return data
            try:
                ...
                for members_type_0_item_data in _members_type_0:
                    ...
                    def _parse_members_type_0_item(
                        data: object,
                    ) -> LoadBalancerMemberCreateType0 | LoadBalancerMemberCreateType1:
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            componentsschemasload_balancer_member_create_type_0 = (
                                LoadBalancerMemberCreateType0.from_dict(data)
                            )

                            return componentsschemasload_balancer_member_create_type_0
                        except (TypeError, ValueError, AttributeError, KeyError):
                            pass
                        if not isinstance(data, dict):
                            raise TypeError()
                        componentsschemasload_balancer_member_create_type_1 = LoadBalancerMemberCreateType1.from_dict(
                            data
                        )

                        return componentsschemasload_balancer_member_create_type_1
                ...
                pass
            return cast(list[LoadBalancerMemberCreateType0 | LoadBalancerMemberCreateType1] | None, data)
        ...
        load_balancer_backend_create = cls(
            name=name,
            members=members,
        ...
        return load_balancer_backend_create
