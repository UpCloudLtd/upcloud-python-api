...
T = TypeVar("T", bound="ServerDiskStatsStatsDaily")


@_attrs_define
class ServerDiskStatsStatsDaily:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        server_disk_stats_stats_daily = cls(
            summary=summary,
        )

        server_disk_stats_stats_daily.additional_properties = d
        return server_disk_stats_stats_daily
