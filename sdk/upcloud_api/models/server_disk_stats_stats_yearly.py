...
T = TypeVar("T", bound="ServerDiskStatsStatsYearly")


@_attrs_define
class ServerDiskStatsStatsYearly:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        server_disk_stats_stats_yearly = cls(
            summary=summary,
        )

        server_disk_stats_stats_yearly.additional_properties = d
        return server_disk_stats_stats_yearly
