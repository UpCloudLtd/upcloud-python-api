...
T = TypeVar("T", bound="LoadBalancerMatcherIntCreateType1")


@_attrs_define
class LoadBalancerMatcherIntCreateType1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        load_balancer_matcher_int_create_type_1 = cls(
            range_start=range_start,
            range_end=range_end,
        )

        load_balancer_matcher_int_create_type_1.additional_properties = d
        return load_balancer_matcher_int_create_type_1
