...
class TestNetwork(object):
    ...
    def test_get_network(self, manager):
        Mock.mock_get('network/03000000-0000-4000-8001-000000000000')
    ...
    def test_create_network(self, manager):
        Mock.mock_post('network', ignore_data_field=True)
    ...
    def test_modify_network(self, manager):
        Mock.mock_put('network/036df3d0-8629-4549-984e-dc86fc3fa1b0', ignore_data_field=True)
    ...
    def test_get_server_networks(self, manager):
        Mock.mock_get('server/0082c083-9847-4f9f-ae04-811251309b35/networking')
    ...
    def test_delete_network_interface(self, manager):
        Mock.mock_delete('server/0082c083-9847-4f9f-ae04-811251309b35/networking/interface/8')
    ...
    def test_delete_network(sekf, manager):
        Mock.mock_delete('network/03000000-0000-4000-8001-000000000000')
    ...
    def test_get_router(self, manager):
        Mock.mock_get('router/03b34bc2-5adf-4fc4-8c44-83f869058f5a')
    ...
    def test_modify_router(self, manager):
        Mock.mock_patch('router/04da7f97-dc03-4df0-868f-239f304ba72f')
        router = manager.modify_router(
            '04da7f97-dc03-4df0-868f-239f304ba72f',
            'test router modify'
        )
    ...
    def test_delete_router(self, manager):
        Mock.mock_delete('router/04da7f97-dc03-4df0-868f-239f304ba72f')
