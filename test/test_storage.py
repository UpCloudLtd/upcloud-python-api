...
class TestStorage(object):
    ...
    def test_get_storage(self, manager):
        Mock.mock_get("storage/01d4fcd4-e446-433b-8a9c-551a1284952e")
    ...
    def test_get_templates(self, manager):
        Mock.mock_get("storage/template")
    ...
    def test_create_storage_backup(self, manager):
        ...
        Mock.mock_post("storage/01d4fcd4-e446-433b-8a9c-551a1284952e/backup")
    ...
    def test_restore_storage_backup(self, manager):
        Mock.mock_get("storage/01350eec-6ebf-4418-abe4-e8bb1d5c9643")
        storage_backup = manager.get_storage("01350eec-6ebf-4418-abe4-e8bb1d5c9643")

        Mock.mock_post("storage/01350eec-6ebf-4418-abe4-e8bb1d5c9643/restore", empty_content=True)
    ...
    def test_templatize_storage(self, manager):
        ...
        Mock.mock_post("storage/01d4fcd4-e446-433b-8a9c-551a1284952e/templatize")
    ...
    def test_upload_file_for_storage_import(self, manager):
        ...
        url_template = "https://fi-hel1.img.upcloud.com/uploader/session/{}"
        session = "07a6c9a3-300e-4d0e-b935-624f3dbdff3f"
        Mock.mock_put(
            url_template.format(session),
            ignore_data_field=True,
            empty_payload=True,
            call_api=False
        )
        ...
        assert res.get("md5sum") == \
            "5cc6f7e7a1c52303ac3137d62410eec5"
        assert res.get("sha256sum") == \
            "bdf14d897406939c11a73d0720ca75c709e756d437f8be9ee26af6b58ede3bd7"

    @responses.activate
    def test_get_storage_import_details(self, manager):
        Mock.mock_get("storage/01d4fcd4-e446-433b-8a9c-551a1284952e/import")
    ...
    def test_storage_update(self, manager):
        ...
        storage = manager.modify_storage(
            "01d4fcd4-e446-433b-8a9c-551a1284952e",
            title="my bigger data collection",
            size=15
        )
        assert type(storage).__name__ == "Storage"
