...
class TestServer(object):
    ...
    def test_get_populated_servers(self, manager):
        Mock.mock_get('server')
        Mock.mock_get('server/00798b85-efdc-41ca-8021-f6ef457b8531')
        Mock.mock_get('server/009d64ef-31d1-4684-a26b-c86c955cbf46')
    ...
    def test_start_server(self, manager):
        ...
        Mock.mock_server_operation('server/009d64ef-31d1-4684-a26b-c86c955cbf46/start')
        server.start()
    ...
    def test_stop_server(self, manager):
        ...
        Mock.mock_server_operation('server/00798b85-efdc-41ca-8021-f6ef457b8531/stop')
        server.stop()
    ...
    def test_restart_server(self, manager):
        ...
        Mock.mock_server_operation('server/00798b85-efdc-41ca-8021-f6ef457b8531/restart')
        server.restart()
    ...
    def test_update_server_oop(self, manager):
        ...
        Mock.mock_put('server/00798b85-efdc-41ca-8021-f6ef457b8531')
        server.save()
